...
export default function Home() {
  ...
  function useBoard(board: GeneratedBoard) {
    setActiveBoard(board);
    setPreviewItems(board.items);
    setShowPreview(false);
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-[380px_1fr]">
          <aside className="space-y-4">
            ...
            <DemoBoardSelector onSelect={useBoard} />
            <BoardHistory boards={history} onSelect={useBoard} />
          </aside>
          ...
          <section className="space-y-4">
            ...
            {!loading && showPreview ? <BoardPreview items={previewItems} onItemsChange={setPreviewItems} onUseBoard={() => activeBoard && useBoard({ ...activeBoard, items: previewItems })} /> : null}
