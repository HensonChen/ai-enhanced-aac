...
function fallbackItems(context: string, maxButtons: number): VocabularyItem[] {
  ...
  const universal = [["happy", "I feel happy", "emotion", "[happy]", true, "phrase"], ["mad", "I am mad", "emotion", "[mad]", true, "phrase"], ["tired", "I am tired", "emotion", "[tired]", true, "phrase"], ["help", "I need help", "social", "[help]", false, "phrase"], ["okay", "I feel okay", "social", "[ok]", false, "phrase"], ["quiet", "I need quiet", "descriptor", "[quiet]", true, "word"], ["break", "I need a break", "verb", "[stop]", true, "phrase"], ["wait", "Please wait", "social", "[time]", true, "phrase"]];
